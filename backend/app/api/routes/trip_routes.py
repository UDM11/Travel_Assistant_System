...
async def plan_trip(request: TripRequest):
    ...
    trip = {
        ...
        "travel_style": getattr(request, 'travel_style', 'mid-range'),
        "accommodation": getattr(request, 'accommodation', 'hotel'),
        "transportation": getattr(request, 'transportation', 'flight'),
        "meal_preference": getattr(request, 'meal_preference', 'all'),
        "activity_level": getattr(request, 'activity_level', 'moderate'),
        "special_requests": getattr(request, 'special_requests', ''),
